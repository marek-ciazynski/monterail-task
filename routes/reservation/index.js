...
module.exports = async function (fastify, opts) {
	...
	fastify.post('/', {
		...
		const { eventId, clientName, tickets } = request.body
		await reservationService.addReservation(eventId, clientName, tickets)
		return { message: `Reservation for event id=${eventId} successfull` }
	})	
}
